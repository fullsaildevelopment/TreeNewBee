...
bool ASingleSwordMan_Enemy::OnAutoDodge(const FDamageInfo * const _damageInfo, const UPawnStatsComponent * const _damageCauserPawnStats)
{
	...
	if (CharacterType != ECharacterType::LanTrooper_Fast && CharacterType != ECharacterType::LanTrooper_Power)
		return false;
...
FName ASingleSwordMan_Enemy::GetDodgeSectionName(const FDamageInfo * const _damageInfo) const
{
	// figure out the anim section to play
	FName animSection;
