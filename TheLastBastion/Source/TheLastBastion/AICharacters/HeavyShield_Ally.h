...
#include "HeavyShield_Ally.generated.h"
...
UCLASS()
class THELASTBASTION_API AHeavyShield_Ally : public ATheLastBastionAllyCharacter
{
	GENERATED_BODY()
...
public:
	...
	FORCEINLINE int GetComboCounter() const override { return CharacterType == ECharacterType::Wolf_Shield_Mace ? FMath::RandRange(Sns_Combo_Counter_Min, Sns_Combo_Counter_Max) : FMath::RandRange(Sns_Ulti_Combo_Counter_Min, Sns_Ulti_Combo_Counter_Max); }
