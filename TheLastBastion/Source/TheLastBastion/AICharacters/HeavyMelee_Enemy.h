...
public:
	...
	FORCEINLINE int GetComboCounter() const override { return CharacterType == ECharacterType::Lan_Heavy ? FMath::RandRange(HV_Combo_Counter_Jr_Min, HV_Combo_Counter_Jr_Max) : FMath::RandRange(HV_Combo_Counter_Sr_Min, HV_Combo_Counter_Sr_Max); }
